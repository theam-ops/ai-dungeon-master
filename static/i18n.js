...
const STRINGS = {
  en: {
    ...
    guide_open: "How this works",
    close: "Close",
    guide_title: "Before your first scene",
    guide_lede: "Four things worth knowing. It takes a minute, and you can reopen it any time from the lobby.",
    guide_dice_h: "The dice are real",
    guide_dice_p: "The DM says the difficulty out loud, then Python rolls it — it cannot decide you succeeded. Every roll shows in the story.",
    guide_together_h: "One person hosts, everyone else opens a link",
    guide_together_p: "Whoever started the game shares its link and a 6-character campaign code. Your friends need no account and install nothing.",
    guide_sheet_h: "Your character is beside the story",
    guide_sheet_p: "HP, skills and what you carry sit in the panel — or behind the tabs on a phone. The ★ opens art, notes and settings.",
    guide_dm_h: "Say what you do, in your own words",
    guide_dm_p: "Not commands. “I shoulder the door open and look for trouble” works better than anything that sounds like a menu.",
    guide_footer: "The DM narrates in whatever language the interface is set to.",
    guide_go: "Start playing",
    ...
    view_detail: "Detail",
    view_skills: "Skills",
    dash_hide: "Hide the panel",
    dash_show: "Show the panel",
    view_party: "Party",
    ...
    ai_install_claude: "Install Claude Code ↗",
  ...
  th: {
    ...
    guide_open: "วิธีเล่น",
    close: "ปิด",
    guide_title: "ก่อนเริ่มฉากแรก",
    guide_lede: "สี่เรื่องที่ควรรู้ ใช้เวลาไม่ถึงนาที และเปิดอ่านซ้ำได้จากหน้าแรกเสมอ",
    guide_dice_h: "ลูกเต๋าเป็นของจริง",
    guide_dice_p: "DM จะประกาศค่าความยากก่อน แล้ว Python เป็นคนทอย มันจึงโกงให้คุณสำเร็จไม่ได้ ทุกการทอยจะแสดงในเรื่องราว",
    guide_together_h: "คนหนึ่งเปิดเซิร์ฟเวอร์ ที่เหลือแค่เปิดลิงก์",
    guide_together_p: "คนที่เปิดเกมจะส่งลิงก์กับรหัสแคมเปญ 6 ตัวอักษรให้ เพื่อนไม่ต้องสมัครอะไร และไม่ต้องติดตั้งอะไรเลย",
    guide_sheet_h: "ตัวละครของคุณอยู่ข้างเรื่องราว",
    guide_sheet_p: "พลังชีวิต ทักษะ และของที่พกอยู่ในแผงข้าง หรือหลังแท็บถ้าเล่นบนมือถือ ปุ่ม ★ เปิดภาพ บันทึก และการตั้งค่า",
    guide_dm_h: "พิมพ์สิ่งที่คุณทำด้วยคำพูดของคุณเอง",
    guide_dm_p: "ไม่ใช่คำสั่ง “ผมกระแทกประตูเข้าไปแล้วมองหาเรื่องวุ่นวาย” ได้ผลดีกว่าอะไรที่ฟังดูเหมือนเมนู",
    guide_footer: "DM จะเล่าเรื่องด้วยภาษาเดียวกับที่ตั้งค่าหน้าจอไว้",
    guide_go: "เริ่มเล่น",
    ...
    view_character: "ตัวละคร",
    view_detail: "รายละเอียด",
    view_skills: "ทักษะ",
    dash_hide: "ซ่อนแผงข้าง",
    dash_show: "แสดงแผงข้าง",
    view_party: "ปาร์ตี้",
    proficient: "ชำนาญ",
    ...
    ai_install_claude: "ติดตั้ง Claude Code ↗",
