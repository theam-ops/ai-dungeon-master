...
const STRINGS = {
  en: {
    ...
    delete_sure: "Delete “{0}”? The story, the characters and every picture go with it. Export it first if you want to keep it — this cannot be undone.",
    ...
    kind_scene: "Scenes",
    kind_map: "Maps",
    kind_handout: "Handouts",
    gallery_describe: "Describe this picture…",
    save: "Save",
    cancel_edit: "Cancel",
    ...
    dm_drew: "The DM illustrates the scene",
  ...
  th: {
    ...
    delete_campaign: "ลบแคมเปญนี้",
    delete_sure: "ลบ “{0}” ไหม? เรื่องราว ตัวละคร และรูปภาพทั้งหมดจะหายไปด้วย ถ้าอยากเก็บไว้ ให้ส่งออกก่อน — ย้อนกลับไม่ได้",
    delete_yes: "ลบเลย",
    cancel: "เก็บไว้",
    deleted: "ลบ “{0}” แล้ว",
    ...
    kind_scene: "ฉาก",
    kind_map: "แผนที่",
    kind_handout: "ภาพประกอบ",
    gallery_describe: "เขียนคำอธิบายภาพนี้…",
    save: "บันทึก",
    cancel_edit: "ยกเลิก",
